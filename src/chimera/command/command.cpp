...
namespace Chimera {
    ...
    void Chimera::get_all_commands() noexcept {
        ...
        // Lightmap specular (shader_environment lightmap-is-specular, boosted metal/glass)
        ADD_COMMAND("chimera_lightmap_specular", "chimera_category_enhancement", "client", lightmap_specular_command, true, 0, 1);
